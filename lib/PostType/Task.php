<?php
/**
 * The class representation of the post type 'task'.
 */
 ...
 */
class Task implements PostType {

    /**
     * This defines the slug of this post type.
     */
    public const SLUG = 'task-cpt';
    ...
    public function __construct() {
        ...
        $this->description = _x( 'Tehtävä', 'theme CPT', 'nuhe' );
    }
    ...
    private function register() {
        $labels = [
            'name'                  => 'Tasks',
            'singular_name'         => _x( 'Tehtävät', 'theme CPT Singular Name', 'nuhe' ),
            'menu_name'             => _x( 'Tehtävät', 'theme CPT', 'nuhe' ),
            'name_admin_bar'        => _x( 'Tehtävät', 'theme CPT', 'nuhe' ),
            'archives'              => _x( 'Tehtävien arkistot', 'theme CPT', 'nuhe' ),
            'attributes'            => _x( 'Tehtävien ominaisuudet', 'theme CPT', 'nuhe' ),
            'parent_item_colon'     => _x( 'Yläsivu:', 'theme CPT', 'nuhe' ),
            'all_items'             => _x( 'Kaikki tehtävät', 'theme CPT', 'nuhe' ),
            'add_new_item'          => _x( 'Lisää uusi tehtävä', 'theme CPT', 'nuhe' ),
            ...
            'view_item'             => _x( 'Näytä tehtävä', 'theme CPT', 'nuhe' ),

...
/**
 * Define the ActivityList class.
 */
class ActivityList extends Field\Flexible\Layout {

    /**
     * Layout key
     */
    const KEY = '_activity_list';
    ...
    private function add_layout_fields() : void {
        ...
        $strings = [
            ...
            'items' => [
                'label' => 'Lisää / poista toimintoja',
            ],
            'link' => [
                'title'        => 'Linkki',
                'instructions' => 'Vapaavalintainen linkki toimintojen jälkeen',
            ],
            'anchor_link_text' => [
                'title'        => 'Ankkurilinkki',
        ...
        $items_field->set_post_types( [ PostType\Activity::SLUG ] );
